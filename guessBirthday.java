...
public class GuessMaster {
	...
	private int totalTicketNum = 0; // total number of tickets that users won
	...
	public static void main(String[] args) {
		...
		System.out.println("=========================");
		// the first parameter is entity's name, the second parameter is entity's
		// birthday and the last parameter of the follow line is the difficulty score
		// described above. Different entity may have other different informations.
	...
	// a clone method for entity
	public Entity clone() throws CloneNotSupportedException {
		return (Entity) super.clone();
	}

	// add a new entity into entities by invoking clone method
	...
	public void playGame(Entity entity) {
		System.out.printf(entity.welcomeMessage()); // call welcomeMessage method in entity
		System.out.printf("\nGuess %s's birthday\n", entity.getName());
		...
		while (true) {
			...
			if (answer.equals("quit")) {
				...
				// if the guess is right answer
					...
					totalTicketNum = totalTicketNum + entity.getAwardedTicketNumber();// calculate the total tickets
																						// that user won
					System.out.println("*************Bingo!***************");
					System.out.println("You won " + entity.getAwardedTicketNumber() + " tickets in this round." + "\n"
							+ "The total number of your tickets is " + totalTicketNum + ".");// print out the ticket
																								// result
					System.out.println("**********************************");
					System.out.println(entity.closingMessage());// call closingMessage method in entity
