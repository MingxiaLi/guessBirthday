...
public class Date {
	...
	// constructor for initializing the Date class
	public Date(String strDate) {
		String[] monDayYear = strDate.split("/"); // spilt the String by "/"
		int monthInt = Integer.valueOf(monDayYear[0]); // the fist value of the String is month input
		int dayInt = Integer.valueOf(monDayYear[1]); // the second value of the String is day input
		int yearInt = Integer.valueOf(monDayYear[2]); // the third value of the String is year input
		setDate(monthInt, dayInt, yearInt); // set the date
	}
